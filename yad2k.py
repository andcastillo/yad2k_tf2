...
from tensorflow.keras.layers import (Conv2D, GlobalAveragePooling2D, Input, Lambda, MaxPooling2D)
...
def _main(args):
    ...
    # There is a bug with h5 in tf2.3. We allow saving in the default format
